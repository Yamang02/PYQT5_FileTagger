...
### 1.1 프로젝트 전체 맥락
본 DRS는 **2025-07-11 확장 로드맵**의 Phase 1에 해당하며, 다음 단계들의 기반이 된다:
- **Phase 2**: Tag Graph Editor 구현
- **Phase 3**: Tag-Based File Browser 구현  
- **Phase 4-6**: QA, 스탠드얼론 패키징, 릴리스

**목표**: 신규 창(Tag Graph Editor, File Browser) 추가 및 스탠드얼론 배포를 위한 견고한 아키텍처 기반 마련
